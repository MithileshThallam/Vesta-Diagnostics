...
export const testCategories: TestCategory[] = [
  {
    id: "endocrinology",
    name: "Endocrinology",
    icon: "🦋",  // Thyroid butterfly shape
    color: "from-purple-500 to-indigo-600",
    description: "Hormone and endocrine system testing",
    keywords: [
      "hormone",
      "endocrine",
      "thyroid",
  ...
  },
  {
    ...
    description: "Blood and blood-forming organs testing",
    keywords: [
      "blood",
      "haematology",
      "hemoglobin",
  ...
  },
  {
    ...
    description: "Microorganism identification and analysis",
    keywords: [
      "microbiology",
      "bacteria",
      "virus",
  ...
  },
  {
    ...
    description: "Heart and cardiovascular system testing",
    keywords: [
      "heart",
      "cardiac",
      "cardiology",
  ...
  },
  {
    id: "immunology",
    name: "Immunology",
    icon: "🛡️",  // Shield representing immune system
    color: "from-indigo-500 to-blue-600",
    description: "Immune system function testing",
    keywords: [
      "immunology",
      "immune",
      "allergy",
  ...
  },
  {
    ...
    description: "Chemical processes and molecular testing",
    keywords: [
      "biochemistry",
      "chemistry",
      "electrolytes",
